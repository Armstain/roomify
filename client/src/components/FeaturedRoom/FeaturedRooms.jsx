        ...
        <div className="relative my-8">
            <Swiper
                ...
                pagination={{
                    clickable: true,
                    type: 'bullets',
                    bulletClass: 'swiper-pagination-bullet bg-indigo-500 w-4 h-4 rounded-full opacity-50 hover:opacity-100',
                }}
                loop={true}
                autoplay={{
                    delay: 3000,
            ...
            {/* Custom Navigation Buttons with Tailwind CSS */}
            <div className="swiper-button-prev absolute top-1/2 left-4 transform -translate-y-1/2 z-10 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-gray-500 hover:text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
