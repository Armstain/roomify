...
const Carousel = () => {
  return (
    <div className="py-10">
      ...
      >
        <SwiperSlide>
          <Slide image={bgimg1} text={"Get the best deal"}></Slide>
        </SwiperSlide>
        <SwiperSlide>
          <Slide image={bgimg2} text={"Stunning View"}></Slide>
        </SwiperSlide>
        <SwiperSlide>
          <Slide image={bgimg3} text={"Affordable Price"}></Slide>
        </SwiperSlide>
        <SwiperSlide>
          <Slide image={bgimg4} text={"Best Offers"}></Slide>
        </SwiperSlide>
      </Swiper>
    </div>
  );
